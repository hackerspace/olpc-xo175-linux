...
#define ABU_PLAYBACK_ONLY_STATUS	0
#define ABU_RECORD_ONLY_STATUS		1
#define ABU_PLAYBACK_RECORD_STATUS	2
#define ABU_IDLE_STATUTS		3
...
struct abu_dma_device {
	...
	struct pxa2xx_pcm_dma_params abu_dma_data[ABU_DMA_CHANNEL_NUMS];
