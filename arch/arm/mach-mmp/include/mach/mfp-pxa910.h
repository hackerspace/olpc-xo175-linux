...
#define GPIO61_HSL_DAT2		MFP_CFG_DRV(GPIO61, AF5, MEDIUM)
#define GPIO62_HSL_DAT1		MFP_CFG_DRV(GPIO62, AF5, MEDIUM)
#define GPIO63_HSL_DAT0		MFP_CFG_DRV(GPIO63, AF5, MEDIUM)
#define GPIO64_HSL_DAT4		MFP_CFG_DRV(GPIO64, AF5, MEDIUM)
#define GPIO65_HSL_DAT3		MFP_CFG_DRV(GPIO65, AF5, MEDIUM)
#define GPIO66_HSL_CLK		MFP_CFG_DRV(GPIO66, AF5, MEDIUM)

/* GSM */
#define GPIO110_RF_GPIO110	MFP_CFG_DRV(GPIO110, AF0, MEDIUM)
#define GPIO111_RF_GPIO111	MFP_CFG_DRV(GPIO111, AF0, MEDIUM)
#define GPIO112_RF_GPIO112	MFP_CFG_DRV(GPIO112, AF0, MEDIUM)
#define GPIO113_RF_GPIO113	MFP_CFG_DRV(GPIO113, AF0, MEDIUM)
#define GPIO114_RF_SPI1_D	MFP_CFG_DRV(GPIO114, AF1, FAST)
#define GPIO115_RF_SPI1_CLK	MFP_CFG_DRV(GPIO115, AF1, FAST)
#define GPIO116_RF_SPI1_STRB0	MFP_CFG_DRV(GPIO116, AF1, FAST)
#define GPIO122_RF_GPIO122	MFP_CFG(GPIO122, AF1)
