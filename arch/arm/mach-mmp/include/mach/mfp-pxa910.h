...
/* UART2 on PXA910H */
#define GPIO45_UART2_RXD	MFP_CFG(GPIO45, AF1)
#define GPIO46_UART2_TXD	MFP_CFG(GPIO46, AF1)
...
/* RF */
/* TDS */
#define GPIO55_TDS_LNACTRL	MFP_CFG_DRV(GPIO55, AF0, VERY_SLOW)
#define GPIO56_TDS_MIXCTRL	MFP_CFG(GPIO56, AF0)
#define GPIO57_TDS_TRXSW	MFP_CFG_DRV(GPIO57, AF0, VERY_SLOW)
#define GPIO58_TDS_RXREV	MFP_CFG_DRV(GPIO58, AF0, VERY_SLOW)
#define GPIO59_TDS_TXREV	MFP_CFG_DRV(GPIO59, AF0, VERY_SLOW)
#define GPIO60_TD_GPIO60	MFP_CFG(GPIO60, AF0)

#define GPIO60_GPIO60		MFP_CFG_DRV(GPIO60, AF0, SLOW)
#define GPIO61_GPIO61		MFP_CFG_DRV(GPIO61, AF5, MEDIUM)
#define GPIO62_GPIO62		MFP_CFG_DRV(GPIO62, AF5, MEDIUM)
#define GPIO63_GPIO63		MFP_CFG_DRV(GPIO63, AF5, MEDIUM)
#define GPIO64_GPIO64		MFP_CFG_DRV(GPIO64, AF5, MEDIUM)
#define GPIO65_GPIO65		MFP_CFG_DRV(GPIO65, AF5, MEDIUM)
#define GPIO66_GPIO66		MFP_CFG_DRV(GPIO66, AF5, MEDIUM)

/* GSM */
#define GPIO110_GPIO110		MFP_CFG_DRV(GPIO110, AF0, MEDIUM)
#define GPIO111_GPIO111		MFP_CFG_DRV(GPIO111, AF0, MEDIUM)
#define GPIO112_GPIO112		MFP_CFG_DRV(GPIO112, AF0, MEDIUM)
#define GPIO113_GPIO113		MFP_CFG_DRV(GPIO113, AF0, MEDIUM)
#define GPIO114_GPIO114		MFP_CFG_DRV(GPIO114, AF1, FAST)
#define GPIO115_GPIO115		MFP_CFG_DRV(GPIO115, AF1, FAST)
#define GPIO116_GPIO116		MFP_CFG_DRV(GPIO116, AF1, FAST)
...
#define GPIO113_GPS_CLKEN   MFP_CFG_DRV(GPIO113, AF0, VERY_SLOW)

/* GPIO */
#define GPIO07_GPIO07		MFP_CFG(GPIO7, AF0)
#define GPIO09_GPIO09		MFP_CFG(GPIO9, AF0)
