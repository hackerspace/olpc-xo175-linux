...
#define GPIO41_TWSI5_SCL	MFP_CFG_DRV(GPIO41, AF2, SLOW) /* for Ariel 2 */
#define GPIO42_TWSI5_SDA	MFP_CFG_DRV(GPIO42, AF2, SLOW) /* for Ariel 2 */
...
#define SSP1_RXD_GPIO_43	MFP_CFG_DRV(GPIO43, AF3,FAST)
#define SSP1_TXD_GPIO_44	MFP_CFG_DRV(GPIO44, AF3,FAST)
#define SSP1_CLK_GPIO_45	MFP_CFG_DRV(GPIO45, AF3,FAST)
#define SSP1_FRM_GPIO_46	MFP_CFG_DRV(GPIO46, AF0,FAST)
...
/* HSIC1 RESET - Wyse Ariel 2 Board */
#define GPIO63_HSIC_RESET	MFP_CFG_LPM(GPIO63, AF0, DRIVE_LOW)
...
/* Ariel ENE EC */
#define ENE_KB_INT_GPIO_60	MFP_CFG_LPM(GPIO60, AF0, FLOAT) // MFP_CFG(GPIO60, AF2) //MFP_CFG_DRV(GPIO60, AF0 , FAST)
#define SPI2_CLK_GPIO_55	MFP_CFG_DRV(GPIO55, AF1, FAST)
#define SPI2_FRM_GPIO_56	MFP_CFG_DRV(GPIO56, AF0, FAST)
#define SPI2_RXD_GPIO_57	MFP_CFG_DRV(GPIO57, AF1, FAST)
#define SPI2_TXD_GPIO_58	MFP_CFG_DRV(GPIO58, AF1, FAST)

/* Ariel Off control */
#define GPIO126_OFF1   MFP_CFG_LPM(GPIO126, AF0, PULL_HIGH)
#define GPIO127_OFF2   MFP_CFG_LPM(GPIO127, AF0, PULL_HIGH)
