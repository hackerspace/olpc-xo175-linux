...
#define GPIO3_GPIO	MFP_CFG(GPIO3, AF0) | MFP_LPM_DRIVE_LOW 
...
#define GPIO64_GPIO	MFP_CFG(GPIO64, AF0) | MFP_LPM_DRIVE_HIGH
#define GPIO65_GPIO	MFP_CFG(GPIO65, AF0)
#define GPIO66_GPIO	MFP_CFG(GPIO66, AF0)
#define GPIO67_GPIO	MFP_CFG(GPIO67, AF0)
#define GPIO68_GPIO	MFP_CFG(GPIO68, AF0) | MFP_LPM_DRIVE_HIGH
...
#define GPIO78_GPIO	MFP_CFG(GPIO78, AF0) | MFP_LPM_DRIVE_LOW
#define GPIO79_GPIO	MFP_CFG(GPIO79, AF0)
#define GPIO80_GPIO	MFP_CFG(GPIO80, AF0)
#define GPIO81_GPIO	MFP_CFG(GPIO81, AF0)
#define GPIO82_GPIO	MFP_CFG(GPIO82, AF0) | MFP_LPM_DRIVE_LOW
#define GPIO83_GPIO	MFP_CFG(GPIO83, AF0)
#define GPIO84_GPIO	MFP_CFG(GPIO84, AF0) | MFP_LPM_DRIVE_LOW 
#define GPIO85_GPIO	MFP_CFG(GPIO85, AF0) | MFP_LPM_DRIVE_LOW 
#define GPIO86_GPIO	MFP_CFG(GPIO86, AF0)
#define GPIO87_GPIO	MFP_CFG(GPIO87, AF0)
#define GPIO88_GPIO	MFP_CFG(GPIO88, AF0)
#define GPIO89_GPIO	MFP_CFG(GPIO89, AF0) | MFP_LPM_DRIVE_HIGH
#define GPIO90_GPIO	MFP_CFG(GPIO90, AF0)
//#define GPIO91_GPIO	MFP_CFG_LPM(GPIO91, AF0, FLOAT)
#define GPIO91_GPIO	MFP_CFG(GPIO91, AF0)
#define GPIO92_GPIO	MFP_CFG(GPIO92, AF0)
#define GPIO93_GPIO	MFP_CFG(GPIO93, AF0) | MFP_PULL_NONE
...
#define GPIO153_GPIO	MFP_CFG_LPM(GPIO153, AF1, DRIVE_HIGH)
...
/*MK2 power saving*/
#define GPIO57_GPIO_LPM_LOW	MFP_CFG_LPM(GPIO57, AF0, DRIVE_LOW)
#define GPIO69_GPIO_LPM_LOW	MFP_CFG_LPM(GPIO69, AF0, DRIVE_LOW)
#define GPIO70_GPIO_LPM_LOW	MFP_CFG_LPM(GPIO70, AF0, DRIVE_LOW)
...
/* T-Lite2 SB, MMP3 B0, UART4 for digitizer*/
#define GPIO65_UART4_RXD        MFP_CFG(GPIO65, AF6)
#define GPIO66_UART4_TXD        MFP_CFG(GPIO66, AF6)
...
//#define GPIO128_LCD_RST		MFP_CFG_LPM(GPIO128, AF0, DRIVE_LOW) /* MMP3 A0*/
#define GPIO128_LCD_RST		MFP_CFG(GPIO128, AF0) //| MFP_LPM_DRIVE_LOW /* MMP3 B0P*/
...
#define GPIO59_HDMI_DET         MFP_CFG(GPIO59, AF0) | MFP_PULL_HIGH 
...
/*MK2 NC pins*/
#define GPIO4_GPIO_NC	MFP_CFG_LPM(GPIO4, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO5_GPIO_NC	MFP_CFG_LPM(GPIO5, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO7_GPIO_NC	MFP_CFG_LPM(GPIO7, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO8_GPIO_NC	MFP_CFG_LPM(GPIO8, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO9_GPIO_NC	MFP_CFG_LPM(GPIO9, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO13_GPIO_NC	MFP_CFG_LPM(GPIO13, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO14_GPIO_NC	MFP_CFG_LPM(GPIO14, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO15_GPIO_NC	MFP_CFG_LPM(GPIO15, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO16_GPIO_NC	MFP_CFG_LPM(GPIO16, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO18_GPIO_NC	MFP_CFG_LPM(GPIO18, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO20_GPIO_NC	MFP_CFG_LPM(GPIO20, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO21_GPIO_NC	MFP_CFG_LPM(GPIO21, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO22_GPIO_NC	MFP_CFG_LPM(GPIO22, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO29_GPIO_NC	MFP_CFG_LPM(GPIO29, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO30_GPIO_NC	MFP_CFG_LPM(GPIO30, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO31_GPIO_NC	MFP_CFG_LPM(GPIO31, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO32_GPIO_NC	MFP_CFG_LPM(GPIO32, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO43_GPIO_NC	MFP_CFG_LPM(GPIO43, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO44_GPIO_NC	MFP_CFG_LPM(GPIO44, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO45_GPIO_NC	MFP_CFG_LPM(GPIO45, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO46_GPIO_NC	MFP_CFG_LPM(GPIO46, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO49_GPIO_NC	MFP_CFG_LPM(GPIO49, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO50_GPIO_NC	MFP_CFG_LPM(GPIO50, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO61_GPIO_NC	MFP_CFG_LPM(GPIO61, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO62_GPIO_NC	MFP_CFG_LPM(GPIO62, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO63_GPIO_NC	MFP_CFG_LPM(GPIO63, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO67_GPIO_NC	MFP_CFG_LPM(GPIO67, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO73_GPIO_NC	MFP_CFG_LPM(GPIO73, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO78_GPIO_NC	MFP_CFG_LPM(GPIO78, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO80_GPIO_NC	MFP_CFG_LPM(GPIO80, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO81_GPIO_NC	MFP_CFG_LPM(GPIO81, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO87_GPIO_NC	MFP_CFG_LPM(GPIO87, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO114_GPIO_NC	MFP_CFG_LPM(GPIO114, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO115_GPIO_NC	MFP_CFG_LPM(GPIO115, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO116_GPIO_NC	MFP_CFG_LPM(GPIO116, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO117_GPIO_NC	MFP_CFG_LPM(GPIO117, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO118_GPIO_NC	MFP_CFG_LPM(GPIO118, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO119_GPIO_NC	MFP_CFG_LPM(GPIO119, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO120_GPIO_NC	MFP_CFG_LPM(GPIO120, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO121_GPIO_NC	MFP_CFG_LPM(GPIO121, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO122_GPIO_NC	MFP_CFG_LPM(GPIO122, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO123_GPIO_NC	MFP_CFG_LPM(GPIO123, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO124_GPIO_NC	MFP_CFG_LPM(GPIO124, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO125_GPIO_NC	MFP_CFG_LPM(GPIO125, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO137_GPIO_NC	MFP_CFG_LPM(GPIO137, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO139_GPIO_NC	MFP_CFG_LPM(GPIO139, AF0,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO143_GPIO_NC	MFP_CFG_LPM(GPIO143, AF1,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO144_GPIO_NC	MFP_CFG_LPM(GPIO144, AF1,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO151_GPIO_NC	MFP_CFG_LPM(GPIO151, AF1,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO155_GPIO_NC	MFP_CFG_LPM(GPIO155, AF1,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO165_GPIO_NC	MFP_CFG_LPM(GPIO165, AF1,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO166_GPIO_NC	MFP_CFG_LPM(GPIO166, AF1,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO167_GPIO_NC	MFP_CFG_LPM(GPIO167, AF1,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO168_GPIO_NC	MFP_CFG_LPM(GPIO168, AF1,DRIVE_LOW) | MFP_PULL_LOW
#define GPIO171_GPIO_NC	MFP_CFG_LPM(GPIO171, AF0,DRIVE_LOW) | MFP_PULL_LOW
