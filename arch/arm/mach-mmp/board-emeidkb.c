...
#define GPIO020_GPIO_CMMB_IRQ		GPIO020_GPIO_20
	...
	GPIO013_GPIO_FLASH_EN | MFP_PULL_FLOAT | MFP_LPM_FLOAT,
...
#define GPIO086_GPIO_GPS_SEN_EN		(GPIO086_GPIO_86 | MFP_PULL_LOW | \
					 MFP_LPM_FLOAT)
	GPIO079_GPIO_CAM_STROBE | MFP_PULL_FLOAT,
...
#define GPIO_GPS_LDO_EN		(SM_CSN1_GPIO_104 | MFPR_PULL_FLOAT)
				...
				struct pm80x_platform_data *pdata)
{
	...
	pm80x_reg_write(chip->power_page, PM800_SLEEP_BUCK1, 0xf);
