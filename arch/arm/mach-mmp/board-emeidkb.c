...
static void regulator_init_pm800(void)
{
	...
	REG_INIT(i++, PM800_ID, BUCK1, 600000, 3950000, 0, 1);

	REG_SUPPLY_INIT(PM800_ID_BUCK2, "v_buck2", NULL);
	REG_INIT(i++, PM800_ID, BUCK2, 600000, 3950000, 0, 1);

	REG_SUPPLY_INIT(PM800_ID_BUCK3, "v_buck3", NULL);
	REG_INIT(i++, PM800_ID, BUCK3, 600000, 3950000, 0, 1);

	REG_SUPPLY_INIT(PM800_ID_BUCK4, "v_rf_vdd", NULL);
	REG_INIT(i++, PM800_ID, BUCK4, 600000, 3950000, 0, 1);
	...
	REG_INIT(i++, PM800_ID, LDO18, 1700000, 3300000, 0, 1);
