...
#define GPIO020_GPIO_CMMB_IRQ		GPIO020_GPIO_20
	...
	GPIO021_I2S_BITCLK | MFP_PULL_LOW,	/* I2S_BITCLK */
	GPIO022_I2S_SYNC | MFP_PULL_LOW,	/* I2S_SYNC */
	GPIO023_I2S_DATA_OUT | MFP_PULL_LOW,	/* I2S_DATA_OUT */
	GPIO024_I2S_SDATA_IN | MFP_PULL_LOW,	/* I2S_DATA_IN */

	GPIO025_GSSP_SCLK | MFP_PULL_LOW,	/* PCM_CLK */
	GPIO026_GSSP_SFRM | MFP_PULL_LOW,	/* PCM_SYNC */
	GPIO027_GSSP_TXD | MFP_PULL_LOW,	/* PCM_TXD */
	GPIO028_GSSP_RXD | MFP_PULL_LOW,	/* PCM_RXD */
