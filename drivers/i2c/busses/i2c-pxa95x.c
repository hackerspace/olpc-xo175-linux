 ...
 *		- CUSTOMIZATION_PER_SLAVE_DEVICE: SLOW, i2c_pxa_custom_nack_is_ok(), CUSTOM_BYTE2BYTE_DELAY
...
{
	int ret;
	i2c->dvfm_lock.lock    = __SPIN_LOCK_UNLOCKED(i2c->dvfm_lock);
...
/*   HANDLER_MODE__DFLT_SLOW_FAST == 0 - use default from upper configurator */
	...
	printk(KERN_INFO "I2C: %s: PXA I2C adapter, slave address %d\n",
	       i2c->adap.dev.init_name, i2c->slave_addr);
#else
