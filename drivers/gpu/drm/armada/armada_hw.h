...
/* Offsets from LCD0_DISP_REGS or LCD1_DISP_REGS */
enum {
	LCD_SPU_DMA_START_ADDR_Y0	= 0x00,
	LCD_SPU_DMA_START_ADDR_U0	= 0x04,
	LCD_SPU_DMA_START_ADDR_V0	= 0x08,
	LCD_CFG_DMA_START_ADDR_0	= 0x0c,
	LCD_SPU_DMA_START_ADDR_Y1	= 0x10,
	LCD_SPU_DMA_START_ADDR_U1	= 0x14,
	LCD_SPU_DMA_START_ADDR_V1	= 0x18,
	LCD_CFG_DMA_START_ADDR_1	= 0x1c,
	LCD_SPU_DMA_PITCH_YC		= 0x20,
	LCD_SPU_DMA_PITCH_UV		= 0x24,
	LCD_SPU_DMA_OVSA_HPXL_VLN	= 0x28,
	LCD_SPU_DMA_HPXL_VLN		= 0x2c,
	LCD_SPU_DZM_HPXL_VLN		= 0x30,
	LCD_CFG_GRA_START_ADDR0		= 0x34,
	LCD_CFG_GRA_START_ADDR1		= 0x38,
	LCD_CFG_GRA_PITCH		= 0x3c,
	LCD_SPU_GRA_OVSA_HPXL_VLN	= 0x40,
	LCD_SPU_GRA_HPXL_VLN		= 0x44,
	LCD_SPU_GZM_HPXL_VLN		= 0x48,
	LCD_SPU_HWC_OVSA_HPXL_VLN	= 0x4c,
	LCD_SPU_HWC_HPXL_VLN		= 0x50,
	LCD_SPUT_V_H_TOTAL		= 0x54,
	LCD_SPU_V_H_ACTIVE		= 0x58,
	LCD_SPU_H_PORCH			= 0x5c,
	LCD_SPU_V_PORCH			= 0x60,
	LCD_SPU_BLANKCOLOR		= 0x64,
	LCD_SPU_ALPHA_COLOR1		= 0x68,
	LCD_SPU_ALPHA_COLOR2		= 0x6c,
	LCD_SPU_COLORKEY_Y		= 0x70,
	LCD_SPU_COLORKEY_U		= 0x74,
	LCD_SPU_COLORKEY_V		= 0x78,
	LCD_CFG_VSYNC_CTRL		= 0x7c,	/* Armada 610/620 */
};

/* Offsets from LCD0_DMA_REGS or LCD1_DMA_REGS */
enum {
	LCD_SPU_DMA_CTRL0		= 0x00,
...
enum {
	...
	SRAM_WRITE		= 2 << 14,
	SRAM_INIT		= 3 << 14,
#define SRAM_GAMMA_YR(n)	((4 * (n) + 0) << 8)
#define SRAM_GAMMA_UG(n)	((4 * (n) + 1) << 8)
#define SRAM_GAMMA_VB(n)	((4 * (n) + 2) << 8)
#define SRAM_PALETTE(n)		((4 * (n) + 3) << 8)
...
enum {
	CFG_VSCALE_LN_EN	= 3 << 18,	/* Armada 510 */
	CFG_GRA_VM_ENA		= 1 << 15,
	CFG_DMA_VM_ENA		= 1 << 13,
	CFG_CMD_VM_ENA		= 1 << 11,
	CFG_CSC_MASK		= 3 << 8,
...
/* For LCD_SPU_IRQ_ENA */
enum {
	LCD0_DMA_FRAME_IRQ0_ENA		= 1 << 31,
	LCD0_DMA_FRAME_IRQ1_ENA		= 1 << 30,
	LCD0_DMA_FRAME_IRQ_ENA		= LCD0_DMA_FRAME_IRQ0_ENA | LCD0_DMA_FRAME_IRQ1_ENA,
	LCD0_DMA_FF_UNDERFLOW_ENA	= 1 << 29,
	LCD0_GRA_FRAME_IRQ0_ENA		= 1 << 27,
	LCD0_GRA_FRAME_IRQ1_ENA		= 1 << 26,
	LCD0_GRA_FRAME_IRQ_ENA		= LCD0_GRA_FRAME_IRQ0_ENA | LCD0_GRA_FRAME_IRQ1_ENA,
	LCD0_GRA_FF_UNDERFLOW_ENA	= 1 << 25,
	LCD0_VSYNC_IRQ_ENA		= 1 << 23,
	LCD0_DUMB_FRAMEDONE_ENA		= 1 << 22,
	...
	PWRDN_IRQ_ENA			= 1 << 17,
	ERR_IRQ_ENA			= 1 << 16,
	LCD1_DMA_FRAME_IRQ0_ENA		= 1 << 15,	/* Armada 620 */
	LCD1_DMA_FRAME_IRQ1_ENA		= 1 << 14,	/* Armada 620 */
	LCD1_DMA_FRAME_IRQ_ENA		= LCD1_DMA_FRAME_IRQ0_ENA | LCD1_DMA_FRAME_IRQ1_ENA,
	LCD1_DMA_FF_UNDERFLOW_ENA	= 1 << 13,	/* Armada 620 */
	LCD1_VSYNC_IRQ_ENA		= 1 << 12,	/* Armada 620 */
	LCD1_GRA_FRAME_IRQ0_ENA		= 1 << 11,	/* Armada 620 */
	LCD1_GRA_FRAME_IRQ1_ENA		= 1 << 10,	/* Armada 620 */
	LCD1_GRA_FRAME_IRQ_ENA		= LCD1_GRA_FRAME_IRQ0_ENA | LCD1_GRA_FRAME_IRQ1_ENA,
	LCD1_GRA_FF_UNDERFLOW_ENA	= 1 << 9,	/* Armada 620 */
	LCD1_FRAMEDONE_ENA		= 1 << 8,	/* Armada 620 */
	CLEAN_SPU_IRQ_ISR		= 0xffff,
};

/* For LCD_SPU_IRQ_ISR */
enum {
	LCD0_DMA_FRAME_IRQ0		= 1 << 31,
	LCD0_DMA_FRAME_IRQ1		= 1 << 30,
	LCD0_DMA_FRAME_IRQ		= LCD0_DMA_FRAME_IRQ0 | LCD0_DMA_FRAME_IRQ1,
	LCD0_DMA_FF_UNDERFLOW		= 1 << 29,
	LCD0_GRA_FRAME_IRQ0		= 1 << 27,
	LCD0_GRA_FRAME_IRQ1		= 1 << 26,
	LCD0_GRA_FRAME_IRQ		= LCD0_GRA_FRAME_IRQ0 | LCD0_GRA_FRAME_IRQ1,
	LCD0_GRA_FF_UNDERFLOW		= 1 << 25,
	LCD0_VSYNC_IRQ			= 1 << 23,
	LCD0_DUMB_FRAMEDONE		= 1 << 22,
	LCD0_TWC_FRAMEDONE		= 1 << 21,
	LCD0_HWC_FRAMEDONE		= 1 << 20,
	SLV_IRQ				= 1 << 19,
	SPI_IRQ				= 1 << 18,
	PWRDN_IRQ			= 1 << 17,
	ERR_IRQ				= 1 << 16,
	LCD1_DMA_FRAME_IRQ0		= 1 << 15,	/* Armada 620 */
	LCD1_DMA_FRAME_IRQ1		= 1 << 14,	/* Armada 620 */
	LCD1_DMA_FF_UNDERFLOW		= 1 << 13,	/* Armada 620 */
	LCD1_VSYNC_IRQ			= 1 << 12,	/* Armada 620 */
	LCD1_GRA_FRAME_IRQ0		= 1 << 11,	/* Armada 620 */
	LCD1_GRA_FRAME_IRQ1		= 1 << 10,	/* Armada 620 */
	LCD1_GRA_FF_UNDERFLOW		= 1 << 9,	/* Armada 620 */
	LCD1_FRAMEDONE			= 1 << 8,	/* Armada 620 */
	LCD0_VSYNC_IRQ_LEVEL		= 1 << 7,
	LCD0_DUMB_FRAMEDONE_LEVEL	= 1 << 6,
