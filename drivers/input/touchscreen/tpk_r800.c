...
static ssize_t tpk800_x_min_show(struct device *dev,
				struct device_attribute *attr, char *buf)

{
	dev_info(dev, "x_min: 0x%x\n", x_min);
	return 0;
}

static ssize_t tpk800_x_max_show(struct device *dev,
				struct device_attribute *attr, char *buf)

{
	dev_info(dev, "x_max: 0x%x\n", x_max);
	return 0;
}
static ssize_t tpk800_y_min_show(struct device *dev,
				struct device_attribute *attr, char *buf)

{
	dev_info(dev, "y_min: 0x%x\n", y_min);
	return 0;
}
static ssize_t tpk800_y_max_show(struct device *dev,
				struct device_attribute *attr, char *buf)

{
	dev_info(dev, "y_max: 0x%x\n", y_max);
	return 0;
}
static ssize_t tpk800_invert_xy_show(struct device *dev,
				struct device_attribute *attr, char *buf)

{
	dev_info(dev, "invert_xy: 0x%x\n", invert_xy);
	return 0;
}

static DEVICE_ATTR(tpk800_x_min, 0555, tpk800_x_min_show, NULL);
static DEVICE_ATTR(tpk800_x_max, 0555, tpk800_x_max_show, NULL);
...
static struct attribute *tpk800_attrs[] = {
	&dev_attr_reset.attr,
	&dev_attr_irq.attr,
	&dev_attr_tpk800_x_min.attr,
	&dev_attr_tpk800_x_max.attr,
	&dev_attr_tpk800_y_min.attr,
	&dev_attr_tpk800_y_max.attr,
	&dev_attr_tpk800_invert_xy.attr,
	NULL
};
