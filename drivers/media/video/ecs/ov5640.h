...
/* 2lane mipi setting */
static struct reg_tab_wb ov5640_mipi_2l_ld[] = {
	{0x3034, 0x18},
	{0x3035, 0x14},
	{0x3036, 0x38},
	{0x3037, 0x13},
...
static struct reg_tab_wb ov5640_mipi_2l_720p[] = {
	{0x3034, 0x18},
	{0x3035, 0x21},
	{0x3036, 0x54},
	{0x3037, 0x13},
...
static struct reg_tab_wb ov5640_mipi_2l_1080p[] = {
	{0x3034, 0x18},
	{0x3035, 0x11},
	{0x3036, 0x54},
	{0x3037, 0x13},
...
static struct reg_tab_wb ov5640_mipi_2l_5m[] = {
	{0x3034, 0x18},
	{0x3035, 0x11},
	{0x3036, 0x4E},
	{0x3037, 0x13},
...
static struct reg_tab_wb ov5640_mipi_2l_jpg[] = {
	{0x3034, 0x18},
	{0x3035, 0x12},
	{0x3036, 0x4E},
	{0x3037, 0x13},
...
#if 0
#define OV5640_DECLARE_MIPI_2L_SETTING(VAL, val) \
	__DECLARE_SETTING_VS_INFO(OV5640, ov5640, MIPI_2L, mipi_2l, VAL, val)
static struct ecs_setting ov5640_mipi_2l_stn_table[OV5640_MIPI_END] = {
	OV5640_DECLARE_MIPI_2L_SETTING(LD, ld),
	OV5640_DECLARE_MIPI_2L_SETTING(JPG, jpg),
	OV5640_DECLARE_MIPI_2L_SETTING(720P, 720p),
	OV5640_DECLARE_MIPI_2L_SETTING(1080P, 1080p),
};
#endif
