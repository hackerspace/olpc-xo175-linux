...
static int smsdvb_onresponse(void *context, struct smscore_buffer_t *cb)
{
	...
	case MSG_SMS_GET_STATISTICS_EX_RES:{
			...
			pMsgData++;
			pStatsIsdbt =
			    (struct SMSHOSTLIB_STATISTICS_ISDBT_S *)pMsgData;
/*
...
*/
			...
			pReceptionData->IsDemodLocked =
			    pStatsIsdbt->IsDemodLocked;
			...
			pReceptionData->CarrierOffset =
			    pStatsIsdbt->CarrierOffset;
			pReceptionData->ErrorTSPackets =
			    pStatsIsdbt->LayerInfo[0].ErrorTSPackets;
