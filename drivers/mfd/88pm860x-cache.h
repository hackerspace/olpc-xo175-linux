...
static void __init pmic_cache_init(int id)
{
	...
	/* regs touched by Apps/Com on TD/TTC */
	0x2B, 0x50, 0x52, 0x59,
	/* Measurement: */
	...
	0xA0, 0xA1, 0xA2, 0xA3,
	/*
	 * According to the APSE report 20-Oct.2011 and by confirmation from PMIC System Engineer the AUDIO
	 * registers 0xB0..0xEF are not power-retain and therefore canNOT be cacheable.
	 */
