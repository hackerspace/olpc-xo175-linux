...
static int kb3930_ec_ram_reg_write(void *context, unsigned int reg, unsigned int val)
{
...
static int kb3930_ec_ram_reg_read(void *context, unsigned int reg, unsigned int *val)
{
	struct kb3930 *priv = context;
	int ret;
