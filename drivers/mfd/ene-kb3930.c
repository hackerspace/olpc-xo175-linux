...
/*
 * ENE Embedded Controller Driver
 *
...
static int kb3930_reg_write(void *context, unsigned int reg, unsigned int val)
{
...
static int kb3930_reg_read(void *context, unsigned int reg, unsigned int *val)
{
	struct kb3930 *priv = context;
	int ret;
...
static const struct regmap_config kb3930_regmap_config = {
	.name = "ec_ram",
	.reg_bits = 8,
	.val_bits = 8,
	.reg_stride = 1,
	.max_register = 0xff,
	.reg_write = kb3930_reg_write,
	.reg_read = kb3930_reg_read,
	.fast_io = false,
};
			...
			const struct i2c_device_id *id)
{
	...
	priv->ec_ram = devm_regmap_init(dev, NULL, priv, &kb3930_regmap_config);
	...
	priv->off_gpios = devm_gpiod_get_array_optional(dev, "off", GPIOD_IN);
